...
public class LopSVEntity  {
	...
	private UserEntity RecivePH;
	
	

	public UserEntity getRecivePH() {
		return RecivePH;
	}

	public void setRecivePH(UserEntity recivePH) {
		RecivePH = recivePH;
	}

	@ManyToOne
	@JoinColumn(name = "sv")
	private UserEntity SV;
	...
	public UserEntity getSV() {
		return SV;
	}

	public void setSV(UserEntity sV) {
		SV = sV;
	}
